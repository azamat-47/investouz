        ...
        <div className="container">
            <div className="row">
                <div className="col-md-8">
                    ...
                    <h3 className='opacity-65 my-3'>Yaratmoqchi Guruhingizni qoshing</h3>
                    ...
                    <div className="addBusinesInfo my-3 border shadow-md rounded-md">
                        <h4 className='mt-2 mx-3'>Guruh haqida</h4>
                        <p className='mx-3'>Bu yerga kiritilgan ma'lumotlar sizni to'g'ri foydalanuvchilar to'plamiga moslashtirish uchun ochiq ko'rsatiladi. Biznesni identifikatsiyalashi mumkin bo'lgan biznes nomi/ma'lumotlarini eslatmang.</p>
                        <hr />
                        ...
                        <form className="form-group mx-3 md:mx-10!">
                            ...
                            <label className=' mt-3! text-sm md:text-lg '>Guruh yig'ish maqsadi </label>
                            <input required type="text" className="form-control" id="name" />


                            <label className=' mt-3! text-sm md:text-lg '>Grouhingiz sohasini kiriting: bir nechta </label>
                            <input required type="text" className="form-control" id="name" placeholder='ex: Turarjoy, MobileApp, StartUp, SavdoMarkazi' />

                            <label className=' mt-3! text-sm md:text-lg '>Grouhingiz qayerda joylashgan? </label>
                            <input required type="text" className="form-control" id="name" placeholder='Bir-necha joy kiritishingiz mumkin' />

                            <label className=' mt-3! text-sm md:text-lg '>Group/Korxonada qancha ishchi bo'lishi kutilmoqda</label>
                            <input required type="number" className="form-control" id="name" />

                            <label className=' mt-3! text-sm md:text-lg '>Guruhingizga nechta kadr kerak </label>
                            <input required type="number" className="form-control" id="name" />

                            <label className=' mt-3! text-sm md:text-lg '>Guruhinngizga qanday kasbdagi shaxslar kerak </label>
                            <input required type="text" className="form-control" id="name" />

                            <label className=' mt-3! text-sm md:text-lg '>Groupni bitta qatorda tasvirlab bering </label>
                            <input required type="text" className="form-control" id="name" placeholder="Bu shior yoki reklama so'zlari bo'lishi mumkin" />

                            <label className=' mt-3! text-sm md:text-lg '>Groupingiz haqida to'liq malumot! </label>
                            <textarea className="form-control" id="exampleFormControlTextarea1" rows={5}
                                placeholder="Groupning eng ko'p sotiladigan mahsulotlari va xizmatlari qanday, ulardan kim foydalanadi va qanday? Mijozlar soni, daromad modeli, promouter tajribasi, Group aloqalari, mukofotlar va hokazolarni o'z ichiga olgan Groupning muhim jihatlarini eslatib o'ting
                            ">

                            </textarea>


                            <label className=' mt-3! text-sm md:text-lg '>Groupingizni asosiy rasmi </label>
                            <div className=" flex items-center justify-center bg-gray-100">
                                <ImgUploader />
                            </div>

                            <label className=' mt-3! text-sm md:text-lg '>Groupingizni 2-rasmi: Ihtiyoriy </label>
                            <div className=" flex items-center justify-center bg-gray-100">
                                <ImgUploader />
                            </div>

                            <label className=' mt-3! text-sm md:text-lg '>Groupingizni 3-rasmi: Ihtiyoriy </label>
                            <div className=" flex items-center justify-center bg-gray-100">
                                <ImgUploader />
                            </div>
